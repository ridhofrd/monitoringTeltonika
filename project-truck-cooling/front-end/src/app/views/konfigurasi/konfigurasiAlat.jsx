...
const KonfigurasiAlat = () => {
  ...
  const calculateLamaSewa = (tanggalAwal, tanggalAkhir) => {
    const [yearAwal, monthAwal, dayAwal] = tanggalAwal
      .split('-')
      .map(Number);
    const [yearAkhir, monthAkhir, dayAkhir] = tanggalAkhir
      .split('-')
      .map(Number);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Jika target pemasangan adalah 'Truck Cooling', kirim data perjalanan
      if (targetPemasangan === 'Truck Cooling') {
      ...
      // Jika target pemasangan adalah 'Cold Storage', kirim data cold storage
