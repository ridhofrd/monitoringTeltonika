          ...
          <Stack spacing={2}>
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Pilih Nama Klien" variant="outlined" />
                )}
                sx={{ width: 500 }}
              />
            </Stack>
                  ...
                  <Stack spacing={2}>
                    <Stack direction="row" spacing={2} alignItems="center">
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params) => (
                          <TextField {...params} label="Pilih Nama Alat" variant="outlined" />
                        )}
                        sx={{ width: 500 }}
                      />
                    </Stack>
                    ...
                    <Button variant="contained" color="success" onClick={handleSaveAlat}>
                      Simpan
                    </Button>
                  </Stack>
                </Box>
            ...
            <Button variant="contained" color="primary" onClick={handleSaveSewa}>
              Simpan Penyewaan
            </Button>
          </Stack>
        </Box>
                  ...
                  sewaData.map((sewa, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell align="center">
                        {sewa.tanggalawalsewa
                          ? new Date(sewa.tanggalawalsewa).toLocaleDateString()
                          : "-"}
                      </TableCell>
                      <TableCell align="center">
                        {sewa.tanggalakhirsewa
                          ? new Date(sewa.tanggalakhirsewa).toLocaleDateString()
                          : "-"}
                      </TableCell>
                      <TableCell align="center">
                        {sewa.tanggalawalsewa && sewa.tanggalakhirsewa
                          ? Math.ceil(
                              (new Date(sewa.tanggalakhirsewa) - new Date(sewa.tanggalawalsewa)) /
                                (1000 * 60 * 60 * 24)
                            )
                          : "-"}{" "}
                        hari
