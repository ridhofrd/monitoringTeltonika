...
import {getSewaByClient} from '../controllers/sewaController.js'
...
//log_track
router.get('api/log_track_id/:id_klien', getLog_trackByIDClient);
router.get('api/log_track/:imei', getLog_trackByIMEI);

//sewa
router.get('api/sewa/:id_klien', getSewaByClient);
