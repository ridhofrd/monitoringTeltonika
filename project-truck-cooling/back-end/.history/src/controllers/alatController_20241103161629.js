...
export const getAlat =  async (req, res) => {
  ...
  export const getAlatFromIMEI = async (req, res) => {
    ...
    try {
      const result = await pool.query(
        "SELECT * FROM public.alat WHERE imei = $1",
        [imei]
      );
    ...
    export const postAlat =  async (req, res) => {
    ...
    export const updateAlatBerdasarkanIMEI =  async (req, res) => {
        const { imei } = req.params;
    ...
    export const hapusAlatBerdasarkanIMEI = async (req, res) => {
    const { imei } = req.params;
    try {
      const result = await pool.query(
