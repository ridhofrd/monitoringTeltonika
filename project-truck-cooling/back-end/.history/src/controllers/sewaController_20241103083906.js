      ...
      const result = await pool.query(
        `INSERT INTO 
         ...
         ($1,
          ...
          $5,
          $6)`
        [dataSewa.id_sewa, dataSewa.id_client, dataSewa.imei, dataSewa.tanggalawalsewa, dataSewa.tanggalakhirsewa, dataSewa.tanggal_transaksi, dataSewa.nomor_transaksi]
      );
      res.json(result.rows);
    } catch (err) {
      console.error(err);
